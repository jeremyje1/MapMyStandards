...
class ContactFormHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            # Send email
            success = self.send_email(first_name, last_name, email, institution, subject, message)
    ...
    def send_email(self, first_name, last_name, email, institution, subject, message):
