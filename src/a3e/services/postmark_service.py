    ...
    def send_assessment_complete_notification(
        ...
        milestone_details = {
            "upload_analysis": {
                ...
                "action_url": "https://platform.mapmystandards.ai/dashboard"
            },
            "report_generated": {
                "icon": "📊", 
                ...
                "action_url": report_url or "https://platform.mapmystandards.ai/reports"
            },
            "standards_mapped": {
                "icon": "🗺️",
                ...
                "action_url": "https://platform.mapmystandards.ai/standards"
            }
        }
