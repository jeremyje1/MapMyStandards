        ...
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
            ...
            <div style="background:white;padding:30px;border:1px solid #e5e7eb;border-radius:0 0 10px 10px;">
                ...
                <div style="text-align:center;margin:30px 0;">
                    <a href="https://platform.mapmystandards.ai/login-platform.html?return=%2Fdashboard-modern.html" style="display:inline-block;padding:12px 30px;background:#3b82f6;color:white;text-decoration:none;border-radius:5px;">Access Your Dashboard</a>
                </div>
