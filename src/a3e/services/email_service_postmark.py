...
class EmailServiceEnhanced:
            ...
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div class="section" style="text-align: center; margin: 30px 0;">
                        <a href="https://platform.mapmystandards.ai/dashboard-modern" class="cta-button">Access Your Dashboard</a>
                    </div>
    ...
    Access your dashboard: https://platform.mapmystandards.ai/dashboard-modern
