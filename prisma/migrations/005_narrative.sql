...
-- CreateEnum
CREATE TYPE "EvidenceStatus" AS ENUM ('AUTO', 'CONFIRMED', 'REJECTED');

-- CreateEnum
CREATE TYPE "NarrativeStatus" AS ENUM ('PENDING', 'GENERATING', 'COMPLETE', 'FAILED');
...
CREATE TABLE "EvidenceLink" (
    ...
    "rationale" TEXT,
    "createdBy" TEXT,
    "status" "EvidenceStatus" NOT NULL DEFAULT 'AUTO',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "GapRun" (
    ...
    CONSTRAINT "GapRun_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "NarrativeRun" (
    ...
    "standardId" TEXT NOT NULL,
    "orgId" TEXT,
    "status" "NarrativeStatus" NOT NULL DEFAULT 'PENDING',
...
-- CreateIndex
CREATE INDEX "EvidenceLink_standardItemId_idx" ON "EvidenceLink"("standardItemId");

-- CreateIndex
CREATE INDEX "EvidenceLink_standardId_idx" ON "EvidenceLink"("standardId");

-- CreateIndex
CREATE INDEX "EvidenceLink_status_idx" ON "EvidenceLink"("status");

-- CreateIndex
CREATE INDEX "EvidenceLink_documentId_version_idx" ON "EvidenceLink"("documentId", "version");

-- CreateIndex
CREATE INDEX "GapRun_standardId_idx" ON "GapRun"("standardId");

-- CreateIndex
CREATE INDEX "GapRun_orgId_idx" ON "GapRun"("orgId");

-- CreateIndex
CREATE INDEX "NarrativeRun_standardId_idx" ON "NarrativeRun"("standardId");

-- CreateIndex
CREATE INDEX "NarrativeRun_orgId_idx" ON "NarrativeRun"("orgId");

-- CreateIndex
CREATE INDEX "NarrativeRun_status_idx" ON "NarrativeRun"("status");
...
-- AddForeignKey
ALTER TABLE "EvidenceLink" ADD CONSTRAINT "EvidenceLink_standardItemId_fkey" FOREIGN KEY ("standardItemId") REFERENCES "StandardItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EvidenceLink" ADD CONSTRAINT "EvidenceLink_standardId_fkey" FOREIGN KEY ("standardId") REFERENCES "Standard"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "GapRun" ADD CONSTRAINT "GapRun_standardId_fkey" FOREIGN KEY ("standardId") REFERENCES "Standard"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "GapRun" ADD CONSTRAINT "GapRun_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Org"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "NarrativeRun" ADD CONSTRAINT "NarrativeRun_standardId_fkey" FOREIGN KEY ("standardId") REFERENCES "Standard"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "NarrativeRun" ADD CONSTRAINT "NarrativeRun_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Org"("id") ON DELETE SET NULL ON UPDATE CASCADE;
